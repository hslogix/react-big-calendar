...
EventRow.propTypes = process.env.NODE_ENV !== "production" ? _objectSpread$7({
...
var MonthView = /*#__PURE__*/function (_React$Component) {
  function MonthView() {
    ...
    _this.getWeeks = memoize(function (date, localizer) {
  ...
  return _createClass(MonthView, [{
    ...
    value: function getWeekEventsMemo(weekIdx) {
      return this._weekEventsMemo[weekIdx] || (this._weekEventsMemo[weekIdx] = memoize(function (weekEvents, accessors, localizer) {
