(function (global, factory) {
  ...
  */
  ...
  function uncontrolledPropTypes(controlledValues, displayName) {
    ...
    Object.keys(controlledValues).forEach(function (prop) {
...

      {
        ...
        !(typeof handler === 'string' && handler.trim().length) ? invariant(false, 'Uncontrollable - [%s]: the prop `%s` needs a valid handler key name in order to make it uncontrollable', displayName, prop)  : void 0;
  ...
  function uncontrollable(Component, controlledValues, methods) {
    ...
    !(canAcceptRef$1 || !methods.length) ? invariant(false, '[uncontrollable] stateless function components cannot pass through methods ' + 'because they have no associated instances. Check component: ' + displayName + ', ' + 'attempting to pass through methods: ' + methods.join(', '))  : void 0;
  ...
  function mergeWithDefaults(localizer, culture, formatOverrides, messages) {
    var formats = _objectSpread$b(_objectSpread$b({}, localizer.formats), formatOverrides);
    return _objectSpread$b(_objectSpread$b({}, localizer), {}, {
      messages: messages,
  ...
  function messages(msgs) {
    return _objectSpread$a(_objectSpread$a({}, defaultMessages), msgs);
  }
  ...
  function ownerWindow(node) {
    const doc = ownerDocument$2(node);
  ...
  const isHTMLElement$1 = e => !!e && 'offsetParent' in e;
  ...
  const getKey$1 = (vendor, k) => `${vendor + (!vendor ? k : k[0].toUpperCase() + k.substr(1))}AnimationFrame`;
  if (canUseDOM$1) {
    vendors.some(vendor => {
  ...
  */
  ...
  function _unsupportedIterableToArray$1(r, a) { if (r) { if ("string" == typeof r) return _arrayLikeToArray$3(r, a); var t = {}.toString.call(r).slice(8, -1); return "Object" === t && r.constructor && (t = r.constructor.name), "Map" === t || "Set" === t ? Array.from(r) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? _arrayLikeToArray$3(r, a) : void 0; } }
  ...
  var VOLATILE_PROPS = ['style', 'className', 'children', 'onDragStart', 'onDragEnd'];
  var EventCell = /*#__PURE__*/function (_React$Component) {
    ...
    return _createClass(EventCell, [{
      ...
      value: function shouldComponentUpdate(nextProps) {
        var keys = new Set([].concat(_toConsumableArray(Object.keys(this.props)), _toConsumableArray(Object.keys(nextProps))));
      ...
      value: function render() {
        ...
        return /*#__PURE__*/React.createElement(EventWrapper, _extends$2({}, this.props, {
          type: "date"
        }), /*#__PURE__*/React.createElement("div", _extends$2({}, props, {
          style: _objectSpread$9(_objectSpread$9({}, userProps.style), style),
  ...
  EventCell.propTypes = "development" !== "production" ? {
  ...
  var Popup = /*#__PURE__*/React.forwardRef(function (props, ref) {
    return /*#__PURE__*/React.createElement(Pop, _extends$2({}, props, {
      popperRef: ref
    }));
  });
  Popup.propTypes = {
  ...
  function CalOverlay(_ref) {
    ...
    return /*#__PURE__*/React.createElement(Overlay, {
      ...
      return /*#__PURE__*/React.createElement(Popup, _extends$2({}, props, {
  ...
  var PopOverlay = /*#__PURE__*/React.forwardRef(function (props, ref) {
    return /*#__PURE__*/React.createElement(CalOverlay, _extends$2({}, props, {
      containerRef: ref
    }));
  });
    ...
    return _createClass(BackgroundCells, [{
      ...
      value: function _selectable() {
        ...
        selector.on('select', function (bounds) {
          _this2._selectSlot(_objectSpread$8(_objectSpread$8({}, _this2.state), {}, {
            action: 'select',
            bounds: bounds
          }));
          _this2._initial = {};
  ...
  BackgroundCells.propTypes = "development" !== "production" ? {
    date: PropTypes.instanceOf(Date),
  ...
  EventRow.propTypes = "development" !== "production" ? _objectSpread$7({
    segments: PropTypes.array
  }, EventRowMixin.propTypes) : {};
  EventRow.defaultProps = _objectSpread$7({}, EventRowMixin.defaultProps);
  ...
  function eventSegments(event, range, accessors, localizer, rangeInfo) {
    var _ref2 = rangeInfo || function () {
        var bounds = endOfRange({
          dateRange: range,
          localizer: localizer
        });
        return _objectSpread$6(_objectSpread$6({}, bounds), {}, {
  ...
  EventEndingRow.propTypes = "development" !== "production" ? _objectSpread$5({
    segments: PropTypes.array,
  ...
  function _unsupportedIterableToArray(r, a) { if (r) { if ("string" == typeof r) return _arrayLikeToArray$2(r, a); var t = {}.toString.call(r).slice(8, -1); return "Object" === t && r.constructor && (t = r.constructor.name), "Map" === t || "Set" === t ? Array.from(r) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? _arrayLikeToArray$2(r, a) : void 0; } }
  ...
  var DateContentRow = /*#__PURE__*/function (_React$Component) {
    ...
    return _createClass(DateContentRow, [{
      ...
      value: function render() {
        ...
        }, range.map(this.renderHeadingCell)), /*#__PURE__*/React.createElement(ScrollableWeekComponent, null, /*#__PURE__*/React.createElement(WeekWrapper, _extends$2({
          isAllDay: isAllDay
        }, eventRowProps, {
          rtl: this.props.rtl
        }), levels.map(function (segs, idx) {
          return /*#__PURE__*/React.createElement(EventRow, _extends$2({
            key: idx,
            segments: segs
          }, eventRowProps));
        }), !!extra.length && /*#__PURE__*/React.createElement(EventEndingRow, _extends$2({
          segments: extra,
  ...
  DateContentRow.propTypes = "development" !== "production" ? {
    date: PropTypes.instanceOf(Date),
    events: PropTypes.array.isRequired,
  ...
  function bucketEventsByWeek(events, weeks, accessors, localizer) {
    ...
    events.forEach(function (event) {
      ...
      for (var w = 0; w < weeks.length; w++) {
        ...
        var week = weeks[w];
        if (inRange(event, week[0], week[week.length - 1], accessors, localizer)) {
  ...
  var MonthView = /*#__PURE__*/function (_React$Component) {
    function MonthView() {
      ...
      _this.getWeeks = memoizeOne(function (date, localizer) {
    ...
    return _createClass(MonthView, [{
      ...
      value: function getWeekEventsMemo(weekIdx) {
        return this._weekEventsMemo[weekIdx] || (this._weekEventsMemo[weekIdx] = memoizeOne(function (weekEvents, accessors, localizer) {
  ...
  MonthView.propTypes = "development" !== "production" ? {
    events: PropTypes.array.isRequired,
    date: PropTypes.instanceOf(Date),
      ...
      value: function render() {
        ...
        return /*#__PURE__*/React.createElement("div", _extends$2({
          ...
          return /*#__PURE__*/React.createElement(Wrapper, {
            ...
            value: value,
            resource: resource
          }, /*#__PURE__*/React.createElement("div", _extends$2({}, slotProps, {
  ...
  function TimeGridEvent(props) {
    ...
    var eventStyle = _objectSpread$3(_objectSpread$3({}, userProps.style), {}, _defineProperty$1({
      top: stringifyPercent(top),
      height: stringifyPercent(height),
      width: stringifyPercent(width)
    }, rtl ? 'right' : 'left', stringifyPercent(xOffset)));
    return /*#__PURE__*/React.createElement(EventWrapper, _extends$2({
      type: "time"
  ...
  var DayColumnWrapper$1 = /*#__PURE__*/React.forwardRef(function (props, ref) {
    return /*#__PURE__*/React.createElement(DayColumnWrapper, _extends$2({}, props, {
      innerRef: ref
    }));
  });
  ...
  DayColumn.propTypes = "development" !== "production" ? {
    events: PropTypes.array.isRequired,
  ...
  TimeGridHeader.propTypes = "development" !== "production" ? {
    range: PropTypes.array.isRequired,
    events: PropTypes.array.isRequired,
  ...
  TimeGridHeaderResources.propTypes = "development" !== "production" ? {
    range: PropTypes.array.isRequired,
    events: PropTypes.array.isRequired,
    resources: PropTypes.object,
    getNow: PropTypes.func.isRequired,
  ...
  TimeGutter.propTypes = "development" !== "production" ? {
    min: PropTypes.instanceOf(Date).isRequired,
    max: PropTypes.instanceOf(Date).isRequired,
  ...
  var TimeGutter$1 = /*#__PURE__*/React.forwardRef(function (props, ref) {
    return /*#__PURE__*/React.createElement(TimeGutter, _extends$2({
      gutterRef: ref
    }, props));
  });
  ...
  var TimeGrid = /*#__PURE__*/function (_Component) {
        ...
        if (popup) {
          ...
          _this.setState({
            overlay: {
              date: date,
              events: events,
              position: _objectSpread$1(_objectSpread$1({}, position$1), {}, {
                width: '200px'
              }),
              target: target
            }
    ...
    return _createClass(TimeGrid, [{
      ...
      value: function renderDayColumn(date, id, resource, groupedEvents, groupedBackgroundEvents, localizer, accessors, components, dayLayoutAlgorithm, now) {
        ...
        return /*#__PURE__*/React.createElement(DayColumn, _extends$2({}, this.props, {
          localizer: localizer,
  ...
  TimeGrid.propTypes = "development" !== "production" ? {
    events: PropTypes.array.isRequired,
    backgroundEvents: PropTypes.array.isRequired,
  ...
  var Day = /*#__PURE__*/function (_React$Component) {
    ...
    return _createClass(Day, [{
      ...
      value: function render() {
        ...
        return /*#__PURE__*/React.createElement(TimeGrid, _extends$2({}, props, {
          range: range,
          eventOffset: 10,
          localizer: localizer,
          min: min,
  ...
  Week.propTypes = "development" !== "production" ? {
    date: PropTypes.instanceOf(Date).isRequired,
    events: PropTypes.array.isRequired,
    backgroundEvents: PropTypes.array.isRequired,
    resources: PropTypes.array,
  ...
  WorkWeek.propTypes = "development" !== "production" ? {
    date: PropTypes.instanceOf(Date).isRequired,
    localizer: PropTypes.any,
    min: PropTypes.instanceOf(Date),
    max: PropTypes.instanceOf(Date),
  ...
  Agenda.propTypes = "development" !== "production" ? {
    accessors: PropTypes.object.isRequired,
    components: PropTypes.object.isRequired,
    date: PropTypes.instanceOf(Date),
    events: PropTypes.array,
  ...
  var VIEWS = _defineProperty$1(_defineProperty$1(_defineProperty$1(_defineProperty$1(_defineProperty$1({}, views$1.MONTH, MonthView), views$1.WEEK, Week), views$1.WORK_WEEK, WorkWeek), views$1.DAY, Day), views$1.AGENDA, Agenda);
  ...
  var omit = /*@__PURE__*/getDefaultExportFromCjs(omitExports);
  ...
  var transform = /*@__PURE__*/getDefaultExportFromCjs(transformExports);
  ...
  var CONTEXT_PROP_KEYS = ['startAccessor', 'endAccessor', 'allDayAccessor', 'tooltipAccessor', 'titleAccessor', 'resourceAccessor', 'resourceIdAccessor', 'resourceTitleAccessor', 'eventIdAccessor', 'eventPropGetter', 'backgroundEventPropGetter', 'slotPropGetter', 'slotGroupPropGetter', 'dayPropGetter', 'view', 'views', 'localizer', 'culture', 'messages', 'components', 'formats'];
  function contextPropsAreEqual(nextProps, prevProps) {
    return CONTEXT_PROP_KEYS.every(function (key) {
  ...
  var Calendar = /*#__PURE__*/function (_React$Component) {
    ...
    return _createClass(Calendar, [{
      ...
      value: function render() {
        ...
        return /*#__PURE__*/React.createElement("div", _extends$2({}, elementProps, {
  ...
  Calendar.propTypes = "development" !== "production" ? {
    /**
  ...
  var isLeapYear$1 = isLeapYear$2.exports;

  var hasRequiredIsLeapYear;

  function requireIsLeapYear () {
  	if (hasRequiredIsLeapYear) return isLeapYear$2.exports;
  	hasRequiredIsLeapYear = 1;
  	(function (module, exports) {
  		!function(e,t){module.exports=t();}(isLeapYear$1,(function(){return function(e,t){t.prototype.isLeapYear=function(){return this.$y%4==0&&this.$y%100!=0||this.$y%400==0};}})); 
  	} (isLeapYear$2));
  	return isLeapYear$2.exports;
  }

  var isLeapYearExports = requireIsLeapYear();
