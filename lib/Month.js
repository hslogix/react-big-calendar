...
var MonthView = /*#__PURE__*/ (function (_PureComponent) {
  function MonthView() {
    ...
    _this.renderWeek = function (week, weekIdx, currentWeekEvents) {
      ...
      var sorted = monthViewNoSortEvents
        ? weeksEvents
        : (0, _eventLevels.sortWeekEvents)(weeksEvents, accessors, localizer)
  ...
  ;(0, _inherits2.default)(MonthView, _PureComponent)
          ...
          if (monthViewWeekOptimization) {
            ...
            var _loop = function _loop() {
              ...
              var idx = ranges.findIndex(function (range) {
                return (0,
                _eventLevels.inRange)(e, range.start, range.end, accessors, localizer)
              })
